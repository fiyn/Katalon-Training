...
WebUI.callTestCase(findTestCase('Day 05 - Training Day/Orange HRM Login (D05)'), [('username') : GlobalVariable.username, ('password') : 'hUKwJTbofgPU9eVlw/CnDQ=='], 
