...
WebUI.sendKeys(findTestObject('Katalon Shop (Ecommerce)/Page_Checkout  Katalon Shop/Page_Checkout  Katalon Shop/input__select2-search__field'), 
...
WebUI.click(findTestObject('Katalon Shop (Ecommerce)/Page_Checkout  Katalon Shop/Page_Checkout  Katalon Shop/span_Selangor'))

WebUI.setText(findTestObject('Katalon Shop (Ecommerce)/Page_Checkout  Katalon Shop/input__select2-search__field'), billingState)
